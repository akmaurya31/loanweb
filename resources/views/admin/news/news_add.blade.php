                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{ route('news.news_store')}}" enctype='multipart/form-data'>
                                    @csrf
                                     ...
                                     <div class="row"> 
                                        <div class="mb-3  col-xl-3">
                                            ...
                                            <div class="">
                                                ...
                                                <input id="Image" type="file" name="bg_image" class="form-control-" >
                                        ...
                                        <div class="mb-3  col-xl-3">
                                            ...
                                            <div class="">
                                                <input type="date" name="days" class="form-control" value="{{ old('days') }}">
